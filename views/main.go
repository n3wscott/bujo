...
func choicesView(m model) string {
	...
	choices := fmt.Sprintf(
		"%s\n%s\n%s\n%s",
		selectLine("Plant carrots", c == 0),
		selectLine("Go to the market", c == 1),
		selectLine("Read something", c == 2),
		selectLine("See friends", c == 3),
	)
...
func selectLine(label string, checked bool) string {
	if checked {
